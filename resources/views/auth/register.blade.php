          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" method="POST" action="{{ route('register')}}">
                ...
                <div class="form-group">
                  <input name="email" type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" id="exampleInputEmail1" placeholder="Email">
                    @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                  <input name="password_confirmation" type="password" class="form-control form-control-lg @error('password_confirmation') is-invalid @enderror" id="exampleRepeatPassword1" placeholder="Repeat Password">
